...
| Conda Package | License name                         | Link                                                             |
|---------------|--------------------------------------|------------------------------------------------------------------|
| requests      | Apache Software License (Apache-2.0) | [GitHub repo](https://github.com/psf/requests/blob/main/LICENSE) |
| vmd-python  | VMD License                         | [GitHub repo](https://github.com/Eigenstate/vmd-python/blob/master/LICENSE)                                                     |
| biopython  | Biopython License Agreement                         | [GitHub repo](https://github.com/biopython/biopython/blob/master/LICENSE.rst)                                                     |
| bioconda::blast  | NCBI-PD                         | [US Government site](https://www.ncbi.nlm.nih.gov/IEB/ToolBox/CPP_DOC/lxr/source/scripts/projects/blast/LICENSE)                                                     |
| plip  | GNU GPLv2                         | [GitHub repo](https://github.com/pharmai/plip/blob/master/LICENSE.txt)                                                     |
| pandas  | BSD 3-Clause License                         | [GitHub repo](https://github.com/pandas-dev/pandas/blob/main/LICENSE)                                                     |
| plotly  | MIT License                         | [GitHub repo](https://github.com/plotly/plotly.py/blob/main/LICENSE.txt)                                                     |
...
| rdkit  | BSD 3-Clause License                         | [GitHub repo](https://github.com/rdkit/rdkit/blob/master/license.txt)    
...
| Data source | License name                         | Link                                                             |
|---------------|--------------------------------------|------------------------------------------------------------------|
| ChEBI  | CC Attribution 4.0 International Public License                         | [Hosting site](https://ftp.ebi.ac.uk/pub/databases/chebi/flat_files/LICENSE)    
| GPCRdb  | CC Attribution 4.0 International Public License                         | [Documentation](https://docs.gpcrdb.org/legal_notice.html)    